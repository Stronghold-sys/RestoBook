...
async function run() {
  console.log("Membaca file SQL migrasi keamanan...");
  const sqlPath = path.join(__dirname, 'migrations', 'create_security_system_tables.sql');
  const sql = fs.readFileSync(sqlPath, 'utf8');

  console.log("Mengirim skema keamanan ke Core Database Supabase...");
  ...
  if (error) {
     ...
     console.log("SUKSES MUTLAK! Tabel dan Kebijakan Keamanan berhasil dibuat.");
  }
