...
async function run() {
  console.log("Adding columns to support_settings...");
  const sql = `
    ALTER TABLE support_settings ADD COLUMN IF NOT EXISTS order_chat_expiry_hours INT DEFAULT 0;
    ALTER TABLE support_settings ADD COLUMN IF NOT EXISTS order_chat_expiry_minutes INT DEFAULT 30;
    ALTER TABLE support_settings ADD COLUMN IF NOT EXISTS order_chat_expiry_seconds INT DEFAULT 0;
