...
async function run() {
  console.log("MEMULAI MIGRASI TRIGGER VOUCHER...");
  ...
  if (error) {
     ...
     if (err2) {
        ...
        console.log("TRIGGER BERHASIL DIBUAT MELALUI JALUR ALTERNATIF!");
     }
  } else {
     console.log("TRIGGER BERHASIL DIBUAT MELALUI RPC UTAMA!");
  }
